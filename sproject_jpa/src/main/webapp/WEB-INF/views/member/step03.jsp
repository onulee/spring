...
<%@ include file="../layout/header.jsp" %>
	...
	<div id="container">
		...
		<div id="outbox">		
			...
			<!-- contents -->
			<div id="contents">
			  <form action="/member/step03" method="post" name="memberFrm">
				...
				<div id="member">
						...
						<table summary="이름, 아이디, 비밀번호, 비밀번호 확인, 이메일, 이메일수신여부, 주소, 휴대폰, 유선전화, 생년월일 순으로 회원가입 정보를 등록할수 있습니다." class="memberWrite" border="1" cellspacing="0">
							...
							<tbody>
								<tr>
									...
									<td><input type="text" name="name" class="w134" /></td>
								</tr>
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li><a onclick="idCheck()" class="nbtnMini">중복확인</a></li>
											<li id="idCheckTxt" style="padding-left:10px;">
												<span class="mvalign orange">* 중복확인을 해주세요.</span>
											</li>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li class="r10"><input type="password" name="pw2" onkeyup="pwCheck()" id="pw2" class="w134" /></li>
											<li id="pwCheckTxt">
								...
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li><input type="text" name="phone" class="w74" maxlength="4" /> <span class="valign">-</span>&nbsp;</li>
											<li class="r10"><input type="text" name="phone" class="w74" maxlength="4" /></li>
									...
									<td>
										<ul class="pta">
											<li>
												<ul class="baseQues">
													<li>
														<input type="radio" name="gender" value="남성" id="male" class="radio_t" checked="checked"/><label for="male">남성</label>
													</li>
													<li>
														<input type="radio" name="gender" value="여성" id="female" class="radio_t" /><label for="female">여성</label>
													</li>
												</ul>
											</li>
										</ul>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li><input type="text" name="email" class="w134" /></li>
											<li><span class="valign">&nbsp;@&nbsp;</span></li>
											<li class="r10"><input type="text" name="email" class="w134" /></li>
											<li>
												<select id="emailList">
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li>
												<input type="text" name="zipcode" id="zipcode" class="w134" />&nbsp;
											</li>
											<li><a onclick="addressBtn()" class="addressBtn"><span>우편번호 찾기</span></a></li>
											<li class="pt5"><input type="text" name="address" id="address" class="addressType" /></li>
											<li class="cb">
								...
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li>&nbsp;<span class="valign">-</span>&nbsp;</li>
											<li><input type="text" name="tel" class="w74" maxlength="4" /> <span class="valign">-</span>&nbsp;</li>
											<li><input type="text" name="tel" class="w74" maxlength="4" /></li>
										</ul>
									</td>
								</tr>
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>
								<li><a onclick="cancelBtn()" class="nbtnbig">취소하기</a></li>
...
function pwCheck(){
	...
	if($("#pw").val() == $("#pw2").val()){
		pwCheckTxt = `<span class="mvalign black">* 비밀번호가 일치입니다.</span>`;
	}else{
		pwCheckTxt = `<span class="mvalign orange">* 비밀번호가 일치하지 않습니다.</span>`;
	}
	$("#pwCheckTxt").html(pwCheckTxt);
}
...
function idCheck(){
	...
	$.ajax({
		...
		success:function(data){
			...
			let idCheckTxt;
			if(data == "사용가능"){
				idCheckTxt = `<span class="mvalign black">* 아이디 사용가능</span>`;
			}else{
				idCheckTxt = `<span class="mvalign orange">* 비밀번호가 일치하지 않습니다.</span>`;
			}
			$("#idCheckTxt").html(idCheckTxt);
		},
		error:function(){
			alert("실패");
		}
